...
tempController = Physics.Temperature; // ui controls for temperature
...
harmonicController = Physics.Harmonic; // ui controls for spring constant
...
lattice.setUI(ui);
lattice.setShowEdges(true); // Make neighbours
...
verletController = Physics.Verlet; //lattice.setForces({name: "Test Force", params: [], color: "red"})
...
Physics.initValence(lattice, 1); // Each function here is called by the renderer every frame

var physics = [verletController.velocityVerlet, verletController.updateState]; // TESTING: push the first node in the x direction to simulate an initial Extension

lattice.data[0].ri.x += 0.5; // setup graphics resources ///////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
...
renderer.ui = ui;
renderer.render(); // non-essential WeLD banner //////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////