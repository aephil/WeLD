...
exports.userInterface = exports["default"] = void 0;
...
var UserInterface = function UserInterface() {
  ...
  var highlightCommand = function highlightCommand(args) {
    var selection = args[0];
  ...
  var moveCommand = function moveCommand(args) {
  ...
  var commandMap = new Map([["focus", focus], ["unfocus", unfocus], ["centre", highlightCommand], ["move", moveCommand]]);
  ...
  var colouredText = function colouredText(msg, colour) {
    return "<text class='" + colour + "'>" + msg + "</text>";
  };

  var initTerminal = function initTerminal(terminal) {
    terminal = document.getElementById("terminal");
    terminal.focus();
    terminal.addEventListener("keydown", function (event) {
      var key = event.keyCode;

      var _char = String.fromCharCode(96 <= key && key <= 105 ? key - 48 : key).toLowerCase(); // If the user has pressed enter
  ...
  var highlight = function highlight(i) {
  ...
  this.showTooltip = function (pos, i) {
    ...
    if (Array.isArray(forces) && forces.length) {
      ...
      for (var _i2 = 0; _i2 < forces.length; _i2++) {
        force = forces[_i2];

        if (_i2 == 2) {
          tooltip.innerHTML += "</br>&emsp;" + (forces.length - _i2) + " more...</br>";
          break;
        }
  ...
  this.slider = function () {
    ...
    slider.setAttribute("value", min); //slider.style.backgroundColor = "blue";
