...
// Bonds ////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////
var Harmonic = function Harmonic() {
  ...
  this.kSpring = function () {
    return kSpring;
  };

  this.kValence = function () {
    return kValence;
  };
  ...
  this.spring = function (d, data) {
    for (var i = 0; i < d.neighbours.length; i++) {
      ...
      dz = Math.abs(d.ri.z - data[nIndex].ri.z); // get unit vector of the vector (dx, dy, dz)
      ...
      extVec = Physics.Vector.sub(equilibrium, vec); // begin debug here
